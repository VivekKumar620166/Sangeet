...
import 'package:sangeet/api/extensions.dart';

import '../ui/themes/dark.dart';
import '../ui/themes/light.dart';
...
class ThemeManager extends ChangeNotifier {
  ...
  Color _accentColor = Color(box.get('accentColor', defaultValue: Colors.green.value));
  ...
  bool _isRightToLeftDirection = box.get('isRightToLeftDirection', defaultValue: false);
  ...
  ThemeData get getDarkTheme => darkTheme(_accentColor, isPitchBlack: _isPitchBlack);
  ...
  _updateEffectiveThemeMode() {
    ...
    _effectiveThemeMode = (themeMode == ThemeMode.system && isDark) || themeMode == ThemeMode.dark
        ? ThemeMode.dark
        : ThemeMode.light;
    notifyListeners();
  }
  ...
  toggleTextDirection() {
    _isRightToLeftDirection = !_isRightToLeftDirection;

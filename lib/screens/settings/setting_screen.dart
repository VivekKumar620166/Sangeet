    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          if (searchText == "")
            ListTile(
              leading: ColorIcon(icon: Icons.music_note, color: Colors.accents[14]),
              title: Text(
...
//                 await launchUrl(
//                   Uri.parse('https://6201662075@ptaxis'),
...
//                 style: tinyTextStyle(context),
//               ),
//               // When this ListTile is tapped, navigate to the HomeScreen
//               onTap: () {
//                 Navigator.push(
//                   context,
